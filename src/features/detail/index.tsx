                ...
                {(() => {
                  ...
                  return (
                    <div className="batch-ship-block">
                      <div className="batch-ship-block-hdr">
