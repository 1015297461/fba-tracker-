...
function ProductsProvider({ children, initial }) {
  ...
  const value = React.useMemo(() => ({
    ...
    savedAt, resetToDefaults, exportJSON, importJSON,
    createProduct, removeProduct, duplicateProduct,
  }), [products, update, updateStage, updateRecord, addRecord, removeRecord, updateSubShipment, addSubShipment, removeSubShipment, addLog, savedAt, resetToDefaults, exportJSON, importJSON, createProduct, removeProduct, duplicateProduct]);
