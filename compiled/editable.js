...
function loadFromStorage(fallback) {
  try {
    ...
    console.warn('[FBA] localStorage load failed', e);
  }
  return fallback;
}
function saveToStorage(products) {
  try {
    ...
    console.warn('[FBA] localStorage save failed', e);
  }
}
function ProductsProvider({
  ...
  const updateStage = React.useCallback((id, stageKey, patch) => {
    setProducts(prev => prev.map(p => {
      ...
      if (typeof patch === 'object' && patch !== null && 'status' in patch) {
        ...
        const nextStageKey = lastDoneIdx >= 0 && lastDoneIdx < keys.length - 1 ? keys[lastDoneIdx + 1] : null;
  ...
  const updateSubShipment = React.useCallback((id, reorderId, ssId, patch) => {
    setProducts(prev => prev.map(p => {
      ...
      const ro = (p.stages.reorder.records || []).map(r => {
        ...
        const ss = (r.subShipments || []).map(x => x.id === ssId ? {
          ...x,
          ...patch
        } : x);
        return {
  ...
  const removeSubShipment = React.useCallback((id, reorderId, ssId) => {
    setProducts(prev => prev.map(p => {
      ...
      const ro = (p.stages.reorder.records || []).map(r => {
        ...
        return {
          ...r,
          subShipments: (r.subShipments || []).filter(x => x.id !== ssId)
        };
      });
      return {
        ...p,
  ...
  const value = React.useMemo(() => ({
    ...
    syncMode,
    syncStatus,
    syncVersion: versionRef.current,
    needLogin,
    currentUser,
    login,
    logout,
...
function StatusChip({
  ...
  return /*#__PURE__*/React.createElement("span", {
    className: "status-chip" + (size === 'sm' ? ' sm' : ''),
    style: {
      color: s.color,
      background: s.bg
    }
...
function StatusSelect({
  ...
  return /*#__PURE__*/React.createElement("span", {
    className: "status-select" + (size === 'sm' ? ' sm' : '')
  ...
  }, STAGE_STATUSES.map(s => /*#__PURE__*/React.createElement("option", {
    key: s.value,
    value: s.value
  }, s.label))));
}
...
function EditField({
  ...
  const commit = () => {
    ...
    if (type === 'number') onChange(local === '' ? '' : Number(local));else onChange(local);
  };
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "input-wrap" + (prefix ? ' has-prefix' : '') + (suffix ? ' has-suffix' : '')
  }, prefix && /*#__PURE__*/React.createElement("span", {
    className: "prefix"
  }, prefix), options ? /*#__PURE__*/React.createElement("select", {
    ...
    key: o.value,
    value: o.value
  }, o.label))) : multi ? /*#__PURE__*/React.createElement("textarea", {
    className: "input",
    value: local,
...
function StageCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onChange: e => updateStage(productId, stageKey, {
  ...
  }), extraHeader), open && /*#__PURE__*/React.createElement("div", {
...
function RecordCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "record-card" + (isFinal ? ' final' : '')
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, title), dates && /*#__PURE__*/React.createElement("span", {
    className: "record-dates"
  }, dates), /*#__PURE__*/React.createElement(StatusSelect, {
    value: status,
    size: "sm",
    onChange: onStatusChange
  }), isFinal && /*#__PURE__*/React.createElement("span", {
    className: "record-final-badge"
  }, "\u6700\u7EC8\u7248"), /*#__PURE__*/React.createElement("button", {
